  ...
  <doc-section id="navbar" name="Navbar">
    <div class="bs-example">
      ...
      <navbar :placement="placement" :type="type">
        ...
        <dropdown text="Components" type="primary">
          <ul slot="dropdown-menu" class="dropdown-menu">
            <li v-for="s in sections"><a :href="'#'+s.id" v-text="s.name"></a></li>
          </ul>
        </dropdown>

        <dropdown text="Forms" type="primary">
          <li v-for="s in sections"><a :href="'#'+s.id" v-text="s.name"></a></li>
        </dropdown>
    ...
    <doc-table>
      <div>
        <p>placement</p>
        <p><code>String</code>, one of <code>top</code>, <code>bottom</code>, <code>static</code>, or empty for normal.
        </p>
        <p><code>''</code></p>
        <p></p>
      </div>
